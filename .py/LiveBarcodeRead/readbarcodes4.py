...
class UI_Window(QWidget):
    ...
    def readBarcode(self, filename):
        reader.init_license("t0069fQAAAI/a2z7Wz1QAXkGMMSyl6T2p/4O/5bFtRdu8rXLUH5bPjUUams3m/UDOKCTfK3tgCLlmk4CIDnglm8cHRnlr/fl6")
#        reader.ProductKeys = "t0069fQAAAI/a2z7Wz1QAXkGMMSyl6T2p/4O/5bFtRdu8rXLUH5bPjUUams3m/UDOKCTfK3tgCLlmk4CIDnglm8cHRnlr/fl6"

        results = reader.decode_file(filename)#template_name="", 0x3FF | 0x2000000 | 0x4000000 | 0x8000000 | 0x10000000)
    ...
    def pickFile(self):
        self.stopCamera()
        # Load an image file.
        filename = QFileDialog.getOpenFileName() #self, 'Open file','C:\\Users\\pluto\\OneDrive\\Documents\\School\\Fourth Year\\SYSC 4907\\Working Directory\\Fridgin-Smart\\.py\\LiveBarcodeRead\\images\\', "Barcode images (*)")
        # Show barcode images
    ...
    def nextFrameSlot(self):
        ...
        results = reader.decode_buffer(frame, 0x3FF | 0x2000000 | 0x4000000 | 0x8000000 | 0x10000000)
        out = ''
        index = 0
        for result in results:
            out += "Index: " + str(index) + "\n"
